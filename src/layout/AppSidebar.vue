...
<template>
  <div class="sc-Axmtr jDbGNF">
    <a aria-current="page" class="active" href="/"
      ><div class="icon">
        <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="22" width="22" fill="#AAAAAA">
          <g><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8"></path></g></svg
        ><span>Home</span>
      </div></a
    ...
    >
    <router-link to="/feed/liked_videos">
      <div class="icon">
        <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" fill="#AAAAAA" width="22" height="22">
          <g>
            <path
    ...
    <div class="ruler"></div>
    <div class="sc-AxheI bWrCIe">
      <h4>Subscriptions</h4>
      <a href="/channel/17396dbd-8cb2-4866-804c-f1c928adc200"
        ><div class="channel"><img src="https://img1.baidu.com/it/u=2871066962,667820075&fm=26&fmt=auto&gp=0.jpg" alt="avatar" /><span>manikandanraji</span></div></a
      ><a href="/channel/bcb6ce6e-2868-4e45-b4ac-d58b84ee22de"
        ><div class="channel"><img src="https://img2.baidu.com/it/u=3761335231,1474741436&fm=26&fmt=auto&gp=0.jpg" alt="avatar" /><span>gamer</span></div></a
      ><a href="/channel/0b39ae9c-611b-41e9-99f3-b9e5c1b15596"
        ><div class="channel"><img src="https://img1.baidu.com/it/u=1884579954,3062285351&fm=26&fmt=auto&gp=0.jpg" alt="avatar" /><span>zhishiqu</span></div></a
      >
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    onMounted(async () => {
      ...
      console.info('data.videos', data.videos)
      console.info('data.videosCount', data.videosCount)
    })
  }
})
</script>