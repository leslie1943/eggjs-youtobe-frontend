  ...
  <div class="sc-AxhUy JixXX">
    ...
    <ul>
      <template v-if="user">
        <li>
          <div>
            <label for="video-upload">
              <svg @click="handleShowUpload" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" height="27" width="27" fill="#FFF" focusable="false">
                <g>
        ...
        <li>
          <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="27" fill="#FFF" width="27">
            <g>
              <path
        ...
        <li>
          <!-- <a href="/feed/my_videos"></a> -->
          <router-link to="/login">
            <img class="sc-AxhCb eSwYtm pointer" src="https://img0.baidu.com/it/u=3949781130,170972349&fm=26&fmt=auto&gp=0.jpg" alt="user-avatar" />
          </router-link>
        </li>
      </template>
      <template v-if="!user">
